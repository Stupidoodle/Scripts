...
void bombus(){
    if (timer_enable.value())
    {
        ...
        Vector2 size_time = text_size("bomb_font", TimeToExplode);
        Vector2 size_c4 = text_size("bomb_font", "C4");
        width = size_time.x;
        ...
        {	
            ...
            draw_text(w2s, Vector2(), "bomb_font", TimeToExplode, fader, 5);
            ...
            draw_text(Vector2(onscreenwidth - width, 10), Vector2(), "bomb_font", TimeToExplode, fader, 5);
		...
		Vector2 size_defuse = text_size("bomb_font", TimeToDefuse);
		width = size_defuse.x;
		...
		if(defuser != -1){
            ...
            draw_text(Vector2(onscreenwidth - width, 20), Vector2(), "bomb_font", TimeToDefuse, blue, 5);
		}
    }
}
...
bool initialize(){
    ...
    add_font("bomb_font", "C:\\Windows\\Fonts\\verdana.ttf", 14.0f);
    return true;
}
